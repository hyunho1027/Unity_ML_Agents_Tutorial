...
### 4-5. Inspector창이 바뀐걸 확인하고, Resolution and Presentation 탭의 설정을 아래와 같이 바꿔줍니다.
...
### 4-6. 다음 Other Settings의 탭으로 이동하여 설정을 아래와 같이 바꿔줍니다.
...
### 4-8. Other Setting 탭의 설정이 변경된 걸 확인하고 Scripting Define Symbols* 를 아래와 같이 설정합니다.
